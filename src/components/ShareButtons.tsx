...
export function ShareButtons({ message, url, heading }: ShareButtonsProps) {
  ...
  const xHref = `https://twitter.com/intent/tweet?text=${encodeURIComponent(message)}&url=${encodeURIComponent(url)}`;
  ...
  return (
    <div className="mt-3 border-t border-zinc-200 pt-3">
      <p className="mb-2 text-sm font-semibold text-zinc-700">{heading ?? t("share.title")}</p>
